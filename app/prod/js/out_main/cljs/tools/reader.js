...
var G__9801 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__9801;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__9802 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__9802,ch);
...
if(("\\" === ch__$1)){
var ch_9803__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_9803__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_9803__$2);
} else {
}

var G__9804 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__9804;
continue;
}
}
...
var vec__9812 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__9812,(0),null);
var start_column = cljs.core.nth.call(null,vec__9812,(1),null);
...
var G__9815 = cljs.core.conj_BANG_.call(null,a,form);
a = G__9815;
continue;
}
}
...
var _STAR_read_delim_STAR_9816 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_9816;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__9817 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__9817,(0),null);
var start_column = cljs.core.nth.call(null,vec__9817,(1),null);
...
var vec__9820 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__9820,(0),null);
var end_column = cljs.core.nth.call(null,vec__9820,(1),null);
...
var vec__9823 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__9823,(0),null);
var start_column = cljs.core.nth.call(null,vec__9823,(1),null);
...
var vec__9826 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__9826,(0),null);
var end_column = cljs.core.nth.call(null,vec__9826,(1),null);
...
var vec__9829 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__9829,(0),null);
var start_column = cljs.core.nth.call(null,vec__9829,(1),null);
...
var vec__9832 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__9832,(0),null);
var end_column = cljs.core.nth.call(null,vec__9832,(1),null);
...
var sb = (function (){var G__9835 = (new goog.string.StringBuffer());
G__9835.append(initch);
...
var G__9837 = (function (){var G__9836 = sb;
G__9836.append(ch);

return G__9836;
})();
var G__9838 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__9837;
ch = G__9838;
continue;
}
...
switch (G__9841) {
case "\\":
var G__9845 = (function (){var G__9842 = sb;
G__9842.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__9842;
})();
var G__9846 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__9845;
ch = G__9846;
continue;
...
break;
default:
var G__9847 = (function (){var G__9843 = sb;
G__9843.append(ch);

return G__9843;
})();
var G__9848 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__9847;
ch = G__9848;
continue;
...
var vec__9849 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__9849,(0),null);
var end_column = cljs.core.nth.call(null,vec__9849,(1),null);
...
var vec__9852 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__9852,(0),null);
var column = cljs.core.nth.call(null,vec__9852,(1),null);
...
var vec__9857 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__9857,(0),null);
var column = cljs.core.nth.call(null,vec__9857,(1),null);
...
var vec__9862 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__9862,(0),null);
var column = cljs.core.nth.call(null,vec__9862,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__9867 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__9867,(0),null);
var start_column = cljs.core.nth.call(null,vec__9867,(1),null);
...
var vec__9870 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__9870,(0),null);
var end_column = cljs.core.nth.call(null,vec__9870,(1),null);
...
var G__9873 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__9873,true,null,opts,pending_forms);
...
var G__9874 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__9874)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__9874)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__9874)){
...
var _STAR_suppress_read_STAR_9875 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_9875;
}});
...
var G__9876 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__9876,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__9876,rdr,first_line);
...
var G__9880 = matched;
var G__9881 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__9880;
finished = G__9881;
continue;
} else {
...
var _STAR_suppress_read_STAR_9882 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_9882;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env9883 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__9884 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__9884,"(");
...
var G__9885 = (i + (1));
var G__9886 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3920__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3920__auto__)){
return or__3920__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env9883;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__9887 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__9887);
...
var G__9888 = cljs.core.next.call(null,s__$1);
var G__9889 = ret;
s__$1 = G__9888;
r = G__9889;
continue;
...
var G__9891 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__9890;
key_vals = G__9891;
continue;
} else {
...
var gensym_env9895 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env9895;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__9896 = token;
var G__9896__$1 = (((G__9896 == null))?null:cljs.core.subs.call(null,G__9896,(1)));
var G__9896__$2 = (((G__9896__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__9896__$1));
var G__9896__$3 = (((G__9896__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__9896__$2));
var G__9896__$4 = (((G__9896__$3 == null))?null:cljs.core.symbol.call(null,G__9896__$3));
if((G__9896__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__9896__$4);
}
})():(function (){var G__9897 = token;
var G__9897__$1 = (((G__9897 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__9897));
if((G__9897__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__9897__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__9908,reader){
var map__9909 = p__9908;
var map__9909__$1 = ((((!((map__9909 == null)))?(((((map__9909.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9909.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9909):map__9909);
var opts = map__9909__$1;
var eof = cljs.core.get.call(null,map__9909__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4497__auto___9917 = arguments.length;
var i__4498__auto___9918 = (0);
while(true){
if((i__4498__auto___9918 < len__4497__auto___9917)){
args__4500__auto__.push((arguments[i__4498__auto___9918]));

var G__9919 = (i__4498__auto___9918 + (1));
i__4498__auto___9918 = G__9919;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq9915){
var G__9916 = cljs.core.first.call(null,seq9915);
var seq9915__$1 = cljs.core.next.call(null,seq9915);
var self__4484__auto__ = this;
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9916,seq9915__$1);
});

...
var buddies = (function (p1__4101_SHARP_){
cljs.core.js__GT_clj.call(null,p1__4101_SHARP_,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], null));
...
return cljs.core.println.call(null,"Opening connection",p1__4102_SHARP_);
});})(socket))
);

socket.on("close",((function (socket){
return (function (p1__4103_SHARP_){
return cljs.core.println.call(null,"Closing connection",p1__4103_SHARP_);
});})(socket))
);

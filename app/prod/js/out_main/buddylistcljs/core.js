...
cljs.core.swap_BANG_.call(null,buddylistcljs.core._STAR_win_STAR_,cljs.core.assoc,new cljs.core.Keyword(null,"buddylist","buddylist",275565366),(new buddylistcljs.core.BrowserWindow(cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"width","width",-384071477),(300),new cljs.core.Keyword(null,"minWidth","minWidth",-204293526),(300),new cljs.core.Keyword(null,"height","height",1025178622),(700),new cljs.core.Keyword(null,"webPreferences","webPreferences",-1267169265),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"nodeIntegration","nodeIntegration",-784873827),true,new cljs.core.Keyword(null,"contextIsolation","contextIsolation",-277188069),false], null)], null)))));
...
return (function (p1__1408_SHARP_){
return cljs.core.println.call(null,"Opening connection",p1__1408_SHARP_);
});})(socket))
);

socket.on("close",((function (socket){
return (function (p1__1409_SHARP_){
return cljs.core.println.call(null,"Closing connection",p1__1409_SHARP_);
});})(socket))
);
...
var temp__4655__auto___1410 = cljs.core.get.call(null,new cljs.core.Keyword(null,"chats","chats",518672204).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,buddylistcljs.core._STAR_win_STAR_)),with_user);
if(cljs.core.truth_(temp__4655__auto___1410)){
var window_1411 = temp__4655__auto___1410;
window_1411.webContents.send("chat:received",e.data);
} else {
}
...
cljs.core.swap_BANG_.call(null,buddylistcljs.core._STAR_win_STAR_,cljs.core.assoc,new cljs.core.Keyword(null,"loading","loading",-737050189),(new buddylistcljs.core.BrowserWindow(cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"width","width",-384071477),(800),new cljs.core.Keyword(null,"height","height",1025178622),(600),new cljs.core.Keyword(null,"frame","frame",-1711082588),false], null)))));
...
var temp__4655__auto___1415 = buddylistcljs.user.get_user.call(null);
if(cljs.core.truth_(temp__4655__auto___1415)){
var user_1416 = temp__4655__auto___1415;
user_1416.then(((function (user_1416,temp__4655__auto___1415){
return (function (u){
...
var socket = (new buddylistcljs.core.client(["ws://50.16.117.236:8000/chat"].join(''),null,cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"authorization","authorization",-166302136),new cljs.core.Keyword(null,"auth-token","auth-token",30990976).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,buddylistcljs.core._STAR_user_STAR_)),new cljs.core.Keyword(null,"request-user","request-user",2052007844),new cljs.core.Keyword(null,"username","username",1605666410).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,buddylistcljs.core._STAR_user_STAR_))], null)], null))));
socket.on("open",((function (socket,user_1416,temp__4655__auto___1415){
return (function (p1__1412_SHARP_){
return cljs.core.println.call(null,"Opening connection",p1__1412_SHARP_);
});})(socket,user_1416,temp__4655__auto___1415))
);

socket.on("close",((function (socket,user_1416,temp__4655__auto___1415){
return (function (p1__1413_SHARP_){
return cljs.core.println.call(null,"Closing connection",p1__1413_SHARP_);
});})(socket,user_1416,temp__4655__auto___1415))
);

socket.on("message",((function (socket,user_1416,temp__4655__auto___1415){
return (function (p1__1414_SHARP_){
return buddylistcljs.core.on_message_recieved.call(null,p1__1414_SHARP_);
});})(socket,user_1416,temp__4655__auto___1415))
);

return buddylistcljs.core.ipc_main.on("chat:sent",((function (socket,user_1416,temp__4655__auto___1415){
...
});})(user_1416,temp__4655__auto___1415))
);
} else {
buddylistcljs.core.launch_unauth_flow.call(null);
}

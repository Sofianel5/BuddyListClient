...
return (new CustomEvent(event_name,(function (){var obj10381 = {"detail":data};
return obj10381;
})()));
} else {
...
var f = (function (){var pred__10388 = cljs.core._EQ_;
var expr__10389 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__10388.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__10389))){
return ((function (pred__10388,expr__10389){
return (function (p1__10382_SHARP_){
return console.warn(p1__10382_SHARP_);
});
;})(pred__10388,expr__10389))
} else {
if(cljs.core.truth_(pred__10388.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__10389))){
return ((function (pred__10388,expr__10389){
return (function (p1__10383_SHARP_){
return console.debug(p1__10383_SHARP_);
});
;})(pred__10388,expr__10389))
} else {
if(cljs.core.truth_(pred__10388.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__10389))){
return ((function (pred__10388,expr__10389){
return (function (p1__10384_SHARP_){
return console.error(p1__10384_SHARP_);
});
;})(pred__10388,expr__10389))
} else {
return ((function (pred__10388,expr__10389){
return (function (p1__10385_SHARP_){
return console.log(p1__10385_SHARP_);
});
;})(pred__10388,expr__10389))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__10392){
...
var opts = map__10393__$1;
var eval_fn = cljs.core.get.call(null,map__10393__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__10395_SHARP_);
});})(new_def))
);
...
return (function (p__10396){
var vec__10397 = p__10396;
var ky = cljs.core.nth.call(null,vec__10397,(0),null);
var v = cljs.core.nth.call(null,vec__10397,(1),null);

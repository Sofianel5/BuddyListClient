...
var G__7623 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__7623;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__7624 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__7624,ch);
...
if(("\\" === ch__$1)){
var ch_7625__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_7625__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_7625__$2);
} else {
}

var G__7626 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__7626;
continue;
}
}
...
var vec__7634 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__7634,(0),null);
var start_column = cljs.core.nth.call(null,vec__7634,(1),null);
...
var G__7637 = cljs.core.conj_BANG_.call(null,a,form);
a = G__7637;
continue;
}
}
...
var _STAR_read_delim_STAR_7638 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_7638;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__7639 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__7639,(0),null);
var start_column = cljs.core.nth.call(null,vec__7639,(1),null);
...
var vec__7642 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__7642,(0),null);
var end_column = cljs.core.nth.call(null,vec__7642,(1),null);
...
var vec__7645 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__7645,(0),null);
var start_column = cljs.core.nth.call(null,vec__7645,(1),null);
...
var vec__7648 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__7648,(0),null);
var end_column = cljs.core.nth.call(null,vec__7648,(1),null);
...
var vec__7651 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__7651,(0),null);
var start_column = cljs.core.nth.call(null,vec__7651,(1),null);
...
var vec__7654 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__7654,(0),null);
var end_column = cljs.core.nth.call(null,vec__7654,(1),null);
...
var G__7660 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__7659;
ch = G__7660;
continue;
}
...
switch (G__7663) {
case "\\":
var G__7667 = (function (){var G__7664 = sb;
G__7664.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__7664;
})();
var G__7668 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__7667;
ch = G__7668;
continue;
...
break;
default:
var G__7669 = (function (){var G__7665 = sb;
G__7665.append(ch);

return G__7665;
})();
var G__7670 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__7669;
ch = G__7670;
continue;
...
var vec__7671 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__7671,(0),null);
var end_column = cljs.core.nth.call(null,vec__7671,(1),null);
...
var vec__7674 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__7674,(0),null);
var column = cljs.core.nth.call(null,vec__7674,(1),null);
...
var vec__7679 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__7679,(0),null);
var column = cljs.core.nth.call(null,vec__7679,(1),null);
...
var line = cljs.core.nth.call(null,vec__7684,(0),null);
var column = cljs.core.nth.call(null,vec__7684,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__7689 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__7689,(0),null);
var start_column = cljs.core.nth.call(null,vec__7689,(1),null);
...
var vec__7692 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__7692,(0),null);
var end_column = cljs.core.nth.call(null,vec__7692,(1),null);
...
var G__7695 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__7695,true,null,opts,pending_forms);
...
var G__7696 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__7696)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__7696)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__7696)){
...
var _STAR_suppress_read_STAR_7697 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_7697;
}});
...
var G__7698 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__7698,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__7698,rdr,first_line);
...
var G__7702 = matched;
var G__7703 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__7702;
finished = G__7703;
continue;
} else {
...
var _STAR_suppress_read_STAR_7704 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_7704;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env7705 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__7706 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__7706,"(");
...
var G__7707 = (i + (1));
var G__7708 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3920__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3920__auto__)){
return or__3920__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env7705;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__7709 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__7709);
...
var G__7710 = cljs.core.next.call(null,s__$1);
var G__7711 = ret;
s__$1 = G__7710;
r = G__7711;
continue;
...
var G__7712 = cljs.core.next.call(null,s);
var G__7713 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__7712;
key_vals = G__7713;
continue;
} else {
...
var gensym_env7717 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env7717;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__7718 = token;
var G__7718__$1 = (((G__7718 == null))?null:cljs.core.subs.call(null,G__7718,(1)));
var G__7718__$2 = (((G__7718__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__7718__$1));
var G__7718__$3 = (((G__7718__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__7718__$2));
var G__7718__$4 = (((G__7718__$3 == null))?null:cljs.core.symbol.call(null,G__7718__$3));
if((G__7718__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__7718__$4);
}
})():(function (){var G__7719 = token;
var G__7719__$1 = (((G__7719 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__7719));
if((G__7719__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__7719__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
}catch (e7726){if((e7726 instanceof Error)){
var e = e7726;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__7730,reader){
var map__7731 = p__7730;
var map__7731__$1 = ((((!((map__7731 == null)))?(((((map__7731.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7731.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7731):map__7731);
var opts = map__7731__$1;
var eof = cljs.core.get.call(null,map__7731__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4497__auto___7739 = arguments.length;
var i__4498__auto___7740 = (0);
while(true){
if((i__4498__auto___7740 < len__4497__auto___7739)){
args__4500__auto__.push((arguments[i__4498__auto___7740]));

var G__7741 = (i__4498__auto___7740 + (1));
i__4498__auto___7740 = G__7741;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq7737){
var G__7738 = cljs.core.first.call(null,seq7737);
var seq7737__$1 = cljs.core.next.call(null,seq7737);
var self__4484__auto__ = this;
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__7738,seq7737__$1);
});

...
var G__10352 = o;
(G__10352[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10354__i < G__10354__a.length) {G__10354__a[G__10354__i] = arguments[G__10354__i + 0]; ++G__10354__i;}
  args = new cljs.core.IndexedSeq(G__10354__a,0,null);
} 
...
var G__10359 = jsprops;
(G__10359["defaultValue"] = value);

(G__10359["onChange"] = ((function (G__10359,v,value,on_change){
return (function (p1__10357_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10357_SHARP_);
});})(G__10359,v,value,on_change))
);

(G__10359["ref"] = ((function (G__10359,v,value,on_change){
return (function (p1__10358_SHARP_){
return (this$["cljsInputElement"] = p1__10358_SHARP_);
});})(G__10359,v,value,on_change))
);
...
var vec__10362 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10362,(0),null);
var id = cljs.core.nth.call(null,vec__10362,(1),null);
var class$ = cljs.core.nth.call(null,vec__10362,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___10366 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___10366 == null)){
} else {
var key_10367 = temp__4661__auto___10366;
(jsprops["key"] = key_10367);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__10368 = (new reagent.impl.template.NativeWrapper());
(G__10368["name"] = c);
...
var len__4497__auto___10372 = arguments.length;
var i__4498__auto___10373 = (0);
while(true){
if((i__4498__auto___10373 < len__4497__auto___10372)){
args__4500__auto__.push((arguments[i__4498__auto___10373]));

var G__10374 = (i__4498__auto___10373 + (1));
i__4498__auto___10373 = G__10374;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10370){
...
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10371,seq10370__$1);
});
...
break;
default:
var G__10377 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__10377;
continue;
...
var n__4374__auto___10379 = a.length;
var i_10380 = (0);
while(true){
if((i_10380 < n__4374__auto___10379)){
(a[i_10380] = reagent.impl.template.as_element.call(null,(a[i_10380])));
...
var a = cljs.core.into_array.call(null,s);
var n__4374__auto___10382 = a.length;
var i_10383 = (0);
while(true){
if((i_10383 < n__4374__auto___10382)){
var val_10384 = (a[i_10383]);
if(((cljs.core.vector_QMARK_.call(null,val_10384)) && ((reagent.impl.template.key_from_vec.call(null,val_10384) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10383] = reagent.impl.template.as_element.call(null,val_10384));

var G__10385 = (i_10383 + (1));
i_10383 = G__10385;
continue;
} else {
}
...
var ctx = ({});
var vec__10386 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__10386,(0),null);
var derefed = cljs.core.nth.call(null,vec__10386,(1),null);
...
var G__10389 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10389) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__10389){

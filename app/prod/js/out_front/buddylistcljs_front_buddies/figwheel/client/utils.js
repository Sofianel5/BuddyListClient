...
return (new CustomEvent(event_name,(function (){var obj13285 = {"detail":data};
return obj13285;
})()));
} else {
...
var f = (function (){var pred__13292 = cljs.core._EQ_;
var expr__13293 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__13292.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__13293))){
return ((function (pred__13292,expr__13293){
return (function (p1__13286_SHARP_){
return console.warn(p1__13286_SHARP_);
});
;})(pred__13292,expr__13293))
} else {
if(cljs.core.truth_(pred__13292.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__13293))){
return ((function (pred__13292,expr__13293){
return (function (p1__13287_SHARP_){
return console.debug(p1__13287_SHARP_);
});
;})(pred__13292,expr__13293))
} else {
if(cljs.core.truth_(pred__13292.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__13293))){
return ((function (pred__13292,expr__13293){
return (function (p1__13288_SHARP_){
return console.error(p1__13288_SHARP_);
});
;})(pred__13292,expr__13293))
} else {
return ((function (pred__13292,expr__13293){
return (function (p1__13289_SHARP_){
return console.log(p1__13289_SHARP_);
});
;})(pred__13292,expr__13293))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__13296){
...
var opts = map__13297__$1;
var eval_fn = cljs.core.get.call(null,map__13297__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__13299_SHARP_);
});})(new_def))
);
...
return (function (p__13300){
var vec__13301 = p__13300;
var ky = cljs.core.nth.call(null,vec__13301,(0),null);
var v = cljs.core.nth.call(null,vec__13301,(1),null);

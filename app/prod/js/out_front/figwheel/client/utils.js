...
return (new CustomEvent(event_name,(function (){var obj8786 = {"detail":data};
return obj8786;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__3909__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__3909__auto__)){
var and__3909__auto____$1 = (window["CustomEvent"]);
...
var f = (function (){var pred__8793 = cljs.core._EQ_;
var expr__8794 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__8793.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__8794))){
return ((function (pred__8793,expr__8794){
return (function (p1__8787_SHARP_){
return console.warn(p1__8787_SHARP_);
});
;})(pred__8793,expr__8794))
} else {
if(cljs.core.truth_(pred__8793.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__8794))){
return ((function (pred__8793,expr__8794){
return (function (p1__8788_SHARP_){
return console.debug(p1__8788_SHARP_);
});
;})(pred__8793,expr__8794))
} else {
if(cljs.core.truth_(pred__8793.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__8794))){
return ((function (pred__8793,expr__8794){
return (function (p1__8789_SHARP_){
return console.error(p1__8789_SHARP_);
});
;})(pred__8793,expr__8794))
} else {
return ((function (pred__8793,expr__8794){
return (function (p1__8790_SHARP_){
return console.log(p1__8790_SHARP_);
});
;})(pred__8793,expr__8794))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__8797){
var map__8798 = p__8797;
var map__8798__$1 = ((((!((map__8798 == null)))?(((((map__8798.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8798.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8798):map__8798);
var opts = map__8798__$1;
var eval_fn = cljs.core.get.call(null,map__8798__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__8800_SHARP_);
});})(new_def))
);
...
return (function (p__8801){
var vec__8802 = p__8801;
var ky = cljs.core.nth.call(null,vec__8802,(0),null);
var v = cljs.core.nth.call(null,vec__8802,(1),null);
...
if(cljs.core.truth_((function (){var and__3909__auto__ = typeof localStorage !== 'undefined';

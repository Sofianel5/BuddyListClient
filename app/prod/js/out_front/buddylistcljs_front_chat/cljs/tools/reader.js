...
var G__4813 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__4813;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4814 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4814,ch);
...
if(("\\" === ch__$1)){
var ch_4815__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4815__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4815__$2);
} else {
}

var G__4816 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4816;
continue;
}
}
...
var vec__4824 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4824,(0),null);
var start_column = cljs.core.nth.call(null,vec__4824,(1),null);
...
var G__4827 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4827;
continue;
}
}
...
var _STAR_read_delim_STAR_4828 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_4828;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4829 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4829,(0),null);
var start_column = cljs.core.nth.call(null,vec__4829,(1),null);
...
var vec__4832 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4832,(0),null);
var end_column = cljs.core.nth.call(null,vec__4832,(1),null);
...
var vec__4835 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4835,(0),null);
var start_column = cljs.core.nth.call(null,vec__4835,(1),null);
...
var vec__4838 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4838,(0),null);
var end_column = cljs.core.nth.call(null,vec__4838,(1),null);
...
var vec__4841 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4841,(0),null);
var start_column = cljs.core.nth.call(null,vec__4841,(1),null);
...
var vec__4844 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4844,(0),null);
var end_column = cljs.core.nth.call(null,vec__4844,(1),null);
...
var sb = (function (){var G__4847 = (new goog.string.StringBuffer());
G__4847.append(initch);
...
var G__4849 = (function (){var G__4848 = sb;
G__4848.append(ch);

return G__4848;
})();
var G__4850 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4849;
ch = G__4850;
continue;
}
...
switch (G__4853) {
case "\\":
var G__4857 = (function (){var G__4854 = sb;
G__4854.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4854;
})();
var G__4858 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4857;
ch = G__4858;
continue;
...
break;
default:
var G__4859 = (function (){var G__4855 = sb;
G__4855.append(ch);

return G__4855;
})();
var G__4860 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4859;
ch = G__4860;
continue;
...
var vec__4861 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4861,(0),null);
var end_column = cljs.core.nth.call(null,vec__4861,(1),null);
...
var line = cljs.core.nth.call(null,vec__4869,(0),null);
var column = cljs.core.nth.call(null,vec__4869,(1),null);
...
var vec__4874 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4874,(0),null);
var column = cljs.core.nth.call(null,vec__4874,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4879 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4879,(0),null);
var start_column = cljs.core.nth.call(null,vec__4879,(1),null);
...
var vec__4882 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4882,(0),null);
var end_column = cljs.core.nth.call(null,vec__4882,(1),null);
...
var G__4885 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4885,true,null,opts,pending_forms);
...
var G__4886 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4886)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4886)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4886)){
...
var _STAR_suppress_read_STAR_4887 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_4887;
}});
...
var G__4888 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4888,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4888,rdr,first_line);
...
var G__4892 = matched;
var G__4893 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4892;
finished = G__4893;
continue;
} else {
...
var _STAR_suppress_read_STAR_4894 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_4894;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env4895 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4896 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4896,"(");
...
var G__4897 = (i + (1));
var G__4898 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3920__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3920__auto__)){
return or__3920__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env4895;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4899 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4899);
...
var G__4900 = cljs.core.next.call(null,s__$1);
var G__4901 = ret;
s__$1 = G__4900;
r = G__4901;
continue;
...
var G__4902 = cljs.core.next.call(null,s);
var G__4903 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4902;
key_vals = G__4903;
continue;
} else {
...
var gensym_env4907 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env4907;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4908 = token;
var G__4908__$1 = (((G__4908 == null))?null:cljs.core.subs.call(null,G__4908,(1)));
var G__4908__$2 = (((G__4908__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4908__$1));
var G__4908__$3 = (((G__4908__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4908__$2));
var G__4908__$4 = (((G__4908__$3 == null))?null:cljs.core.symbol.call(null,G__4908__$3));
if((G__4908__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4908__$4);
}
})():(function (){var G__4909 = token;
var G__4909__$1 = (((G__4909 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4909));
if((G__4909__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4909__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
}catch (e4916){if((e4916 instanceof Error)){
var e = e4916;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4920,reader){
...
var eof = cljs.core.get.call(null,map__4921__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4497__auto___4929 = arguments.length;
var i__4498__auto___4930 = (0);
while(true){
if((i__4498__auto___4930 < len__4497__auto___4929)){
args__4500__auto__.push((arguments[i__4498__auto___4930]));

var G__4931 = (i__4498__auto___4930 + (1));
i__4498__auto___4930 = G__4931;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq4927){
var G__4928 = cljs.core.first.call(null,seq4927);
var seq4927__$1 = cljs.core.next.call(null,seq4927);
var self__4484__auto__ = this;
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__4928,seq4927__$1);
});

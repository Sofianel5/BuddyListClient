...
var G__1690 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__1690;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__1691 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__1691,ch);
...
if(("\\" === ch__$1)){
var ch_1692__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_1692__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_1692__$2);
} else {
}

var G__1693 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__1693;
continue;
}
}
...
var vec__1701 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1701,(0),null);
var start_column = cljs.core.nth.call(null,vec__1701,(1),null);
...
var G__1704 = cljs.core.conj_BANG_.call(null,a,form);
a = G__1704;
continue;
}
}
...
var _STAR_read_delim_STAR_1705 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_1705;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__1706 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1706,(0),null);
var start_column = cljs.core.nth.call(null,vec__1706,(1),null);
...
var vec__1709 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1709,(0),null);
var end_column = cljs.core.nth.call(null,vec__1709,(1),null);
...
var vec__1712 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1712,(0),null);
var start_column = cljs.core.nth.call(null,vec__1712,(1),null);
...
var vec__1715 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1715,(0),null);
var end_column = cljs.core.nth.call(null,vec__1715,(1),null);
...
var vec__1718 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1718,(0),null);
var start_column = cljs.core.nth.call(null,vec__1718,(1),null);
...
var vec__1721 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1721,(0),null);
var end_column = cljs.core.nth.call(null,vec__1721,(1),null);
...
var sb = (function (){var G__1724 = (new goog.string.StringBuffer());
G__1724.append(initch);
...
var G__1726 = (function (){var G__1725 = sb;
G__1725.append(ch);

return G__1725;
})();
var G__1727 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__1726;
ch = G__1727;
continue;
}
...
switch (G__1730) {
case "\\":
var G__1734 = (function (){var G__1731 = sb;
G__1731.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__1731;
})();
var G__1735 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__1734;
ch = G__1735;
continue;
...
break;
default:
var G__1736 = (function (){var G__1732 = sb;
G__1732.append(ch);

return G__1732;
})();
var G__1737 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__1736;
ch = G__1737;
continue;
...
var vec__1738 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1738,(0),null);
var end_column = cljs.core.nth.call(null,vec__1738,(1),null);
...
var vec__1741 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__1741,(0),null);
var column = cljs.core.nth.call(null,vec__1741,(1),null);
...
var vec__1746 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__1746,(0),null);
var column = cljs.core.nth.call(null,vec__1746,(1),null);
...
var vec__1751 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__1751,(0),null);
var column = cljs.core.nth.call(null,vec__1751,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__1756 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1756,(0),null);
var start_column = cljs.core.nth.call(null,vec__1756,(1),null);
...
var vec__1759 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1759,(0),null);
var end_column = cljs.core.nth.call(null,vec__1759,(1),null);
...
var G__1762 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__1762,true,null,opts,pending_forms);
...
var G__1763 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__1763)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__1763)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__1763)){
...
var _STAR_suppress_read_STAR_1764 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_1764;
}});
...
var G__1765 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__1765,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__1765,rdr,first_line);
...
var G__1769 = matched;
var G__1770 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__1769;
finished = G__1770;
continue;
} else {
...
var _STAR_suppress_read_STAR_1771 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_1771;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env1772 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__1773 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__1773,"(");
...
var G__1774 = (i + (1));
var G__1775 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3920__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3920__auto__)){
return or__3920__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env1772;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__1776 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__1776);
...
var G__1777 = cljs.core.next.call(null,s__$1);
var G__1778 = ret;
s__$1 = G__1777;
r = G__1778;
continue;
...
var G__1779 = cljs.core.next.call(null,s);
var G__1780 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__1779;
key_vals = G__1780;
continue;
} else {
...
var gensym_env1784 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env1784;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__1785 = token;
var G__1785__$1 = (((G__1785 == null))?null:cljs.core.subs.call(null,G__1785,(1)));
var G__1785__$2 = (((G__1785__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__1785__$1));
var G__1785__$3 = (((G__1785__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__1785__$2));
var G__1785__$4 = (((G__1785__$3 == null))?null:cljs.core.symbol.call(null,G__1785__$3));
if((G__1785__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__1785__$4);
}
})():(function (){var G__1786 = token;
var G__1786__$1 = (((G__1786 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__1786));
if((G__1786__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__1786__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
}catch (e1793){if((e1793 instanceof Error)){
var e = e1793;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__1797,reader){
var map__1798 = p__1797;
var map__1798__$1 = ((((!((map__1798 == null)))?(((((map__1798.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1798.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1798):map__1798);
var opts = map__1798__$1;
var eof = cljs.core.get.call(null,map__1798__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4497__auto___1806 = arguments.length;
var i__4498__auto___1807 = (0);
while(true){
if((i__4498__auto___1807 < len__4497__auto___1806)){
args__4500__auto__.push((arguments[i__4498__auto___1807]));

var G__1808 = (i__4498__auto___1807 + (1));
i__4498__auto___1807 = G__1808;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq1804){
var G__1805 = cljs.core.first.call(null,seq1804);
var seq1804__$1 = cljs.core.next.call(null,seq1804);
var self__4484__auto__ = this;
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__1805,seq1804__$1);
});

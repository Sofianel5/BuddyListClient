...
var G__10911 = o;
(G__10911[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10913__i < G__10913__a.length) {G__10913__a[G__10913__i] = arguments[G__10913__i + 0]; ++G__10913__i;}
  args = new cljs.core.IndexedSeq(G__10913__a,0,null);
} 
...
return G__10912__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__3909__auto__ = !((jsprops == null));
if(and__3909__auto__){
var and__3909__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__10918 = jsprops;
(G__10918["defaultValue"] = value);

(G__10918["onChange"] = ((function (G__10918,v,value,on_change){
return (function (p1__10916_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10916_SHARP_);
});})(G__10918,v,value,on_change))
);

(G__10918["ref"] = ((function (G__10918,v,value,on_change){
return (function (p1__10917_SHARP_){
return (this$["cljsInputElement"] = p1__10917_SHARP_);
});})(G__10918,v,value,on_change))
);
...
var vec__10921 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10921,(0),null);
var id = cljs.core.nth.call(null,vec__10921,(1),null);
var class$ = cljs.core.nth.call(null,vec__10921,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___10925 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___10925 == null)){
} else {
var key_10926 = temp__4661__auto___10925;
(jsprops["key"] = key_10926);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__10927 = (new reagent.impl.template.NativeWrapper());
(G__10927["name"] = c);
...
var len__4497__auto___10931 = arguments.length;
var i__4498__auto___10932 = (0);
while(true){
if((i__4498__auto___10932 < len__4497__auto___10931)){
args__4500__auto__.push((arguments[i__4498__auto___10932]));

var G__10933 = (i__4498__auto___10932 + (1));
i__4498__auto___10932 = G__10933;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10929){
var G__10930 = cljs.core.first.call(null,seq10929);
var seq10929__$1 = cljs.core.next.call(null,seq10929);
var self__4484__auto__ = this;
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10930,seq10929__$1);
});
...
break;
default:
var G__10936 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__10936;
continue;
...
var n__4374__auto___10938 = a.length;
var i_10939 = (0);
while(true){
if((i_10939 < n__4374__auto___10938)){
(a[i_10939] = reagent.impl.template.as_element.call(null,(a[i_10939])));

var G__10940 = (i_10939 + (1));
i_10939 = G__10940;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4374__auto___10941 = a.length;
var i_10942 = (0);
while(true){
if((i_10942 < n__4374__auto___10941)){
var val_10943 = (a[i_10942]);
if(((cljs.core.vector_QMARK_.call(null,val_10943)) && ((reagent.impl.template.key_from_vec.call(null,val_10943) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10942] = reagent.impl.template.as_element.call(null,val_10943));

var G__10944 = (i_10942 + (1));
i_10942 = G__10944;
continue;
} else {
}
...
var ctx = ({});
var vec__10945 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__10945,(0),null);
var derefed = cljs.core.nth.call(null,vec__10945,(1),null);
...
var G__10948 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10948) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__10948){

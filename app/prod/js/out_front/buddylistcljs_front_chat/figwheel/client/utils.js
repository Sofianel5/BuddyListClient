...
return (new CustomEvent(event_name,(function (){var obj5964 = {"detail":data};
return obj5964;
})()));
} else {
...
var f = (function (){var pred__5971 = cljs.core._EQ_;
var expr__5972 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__5971.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__5972))){
return ((function (pred__5971,expr__5972){
return (function (p1__5965_SHARP_){
return console.warn(p1__5965_SHARP_);
});
;})(pred__5971,expr__5972))
} else {
if(cljs.core.truth_(pred__5971.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__5972))){
return ((function (pred__5971,expr__5972){
return (function (p1__5966_SHARP_){
return console.debug(p1__5966_SHARP_);
});
;})(pred__5971,expr__5972))
} else {
if(cljs.core.truth_(pred__5971.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__5972))){
return ((function (pred__5971,expr__5972){
return (function (p1__5967_SHARP_){
return console.error(p1__5967_SHARP_);
});
;})(pred__5971,expr__5972))
} else {
return ((function (pred__5971,expr__5972){
return (function (p1__5968_SHARP_){
return console.log(p1__5968_SHARP_);
});
;})(pred__5971,expr__5972))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__5975){
...
var opts = map__5976__$1;
var eval_fn = cljs.core.get.call(null,map__5976__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__5978_SHARP_);
});})(new_def))
);
...
return (function (p__5979){
var vec__5980 = p__5979;
var ky = cljs.core.nth.call(null,vec__5980,(0),null);

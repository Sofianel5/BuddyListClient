...
return (new CustomEvent(event_name,(function (){var obj2841 = {"detail":data};
return obj2841;
})()));
} else {
...
var f = (function (){var pred__2848 = cljs.core._EQ_;
var expr__2849 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__2848.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__2849))){
return ((function (pred__2848,expr__2849){
return (function (p1__2842_SHARP_){
return console.warn(p1__2842_SHARP_);
});
;})(pred__2848,expr__2849))
} else {
if(cljs.core.truth_(pred__2848.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__2849))){
return ((function (pred__2848,expr__2849){
return (function (p1__2843_SHARP_){
return console.debug(p1__2843_SHARP_);
});
;})(pred__2848,expr__2849))
} else {
if(cljs.core.truth_(pred__2848.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__2849))){
return ((function (pred__2848,expr__2849){
return (function (p1__2844_SHARP_){
return console.error(p1__2844_SHARP_);
});
;})(pred__2848,expr__2849))
} else {
return ((function (pred__2848,expr__2849){
return (function (p1__2845_SHARP_){
return console.log(p1__2845_SHARP_);
});
;})(pred__2848,expr__2849))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__2852){
var map__2853 = p__2852;
var map__2853__$1 = ((((!((map__2853 == null)))?(((((map__2853.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2853.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2853):map__2853);
var opts = map__2853__$1;
var eval_fn = cljs.core.get.call(null,map__2853__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__2855_SHARP_);
});})(new_def))
);
...
return (function (p__2856){
var vec__2857 = p__2856;
var ky = cljs.core.nth.call(null,vec__2857,(0),null);
var v = cljs.core.nth.call(null,vec__2857,(1),null);

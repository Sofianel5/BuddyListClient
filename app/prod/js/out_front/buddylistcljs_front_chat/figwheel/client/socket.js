...
}catch (e6948){if((e6948 instanceof Error)){
var e = e6948;
return null;
} else {
throw e6948;
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__6949){
var map__6950 = p__6949;
var map__6950__$1 = ((((!((map__6950 == null)))?(((((map__6950.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6950.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6950):map__6950);
var opts = map__6950__$1;
var retry_count = cljs.core.get.call(null,map__6950__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__6950__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__6950__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__6950__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
...
socket.onclose = ((function (url,socket,WebSocket,temp__4655__auto__,map__6950,map__6950__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4655__auto__,map__6950,map__6950__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4655__auto__,map__6950,map__6950__$1,opts,retry_count,retried_count,websocket_url,build_id))
...
socket.onerror = ((function (url,socket,WebSocket,temp__4655__auto__,map__6950,map__6950__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){

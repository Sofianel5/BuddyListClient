...
var G__6917 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__6917;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__6918 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__6918,ch);
...
if(("\\" === ch__$1)){
var ch_6919__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_6919__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_6919__$2);
} else {
}

var G__6920 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__6920;
continue;
}
}
...
var vec__6928 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6928,(0),null);
var start_column = cljs.core.nth.call(null,vec__6928,(1),null);
...
var G__6931 = cljs.core.conj_BANG_.call(null,a,form);
a = G__6931;
continue;
}
}
...
var _STAR_read_delim_STAR_6932 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_6932;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__6933 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6933,(0),null);
var start_column = cljs.core.nth.call(null,vec__6933,(1),null);
...
var vec__6936 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6936,(0),null);
var end_column = cljs.core.nth.call(null,vec__6936,(1),null);
...
var vec__6939 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6939,(0),null);
var start_column = cljs.core.nth.call(null,vec__6939,(1),null);
...
var vec__6942 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6942,(0),null);
var end_column = cljs.core.nth.call(null,vec__6942,(1),null);
...
var vec__6945 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6945,(0),null);
var start_column = cljs.core.nth.call(null,vec__6945,(1),null);
...
var vec__6948 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6948,(0),null);
var end_column = cljs.core.nth.call(null,vec__6948,(1),null);
...
var sb = (function (){var G__6951 = (new goog.string.StringBuffer());
G__6951.append(initch);
...
var G__6953 = (function (){var G__6952 = sb;
G__6952.append(ch);

return G__6952;
})();
var G__6954 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__6953;
ch = G__6954;
continue;
}
...
switch (G__6957) {
case "\\":
var G__6961 = (function (){var G__6958 = sb;
G__6958.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__6958;
})();
var G__6962 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__6961;
ch = G__6962;
continue;
...
break;
default:
var G__6963 = (function (){var G__6959 = sb;
G__6959.append(ch);

return G__6959;
})();
var G__6964 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__6963;
ch = G__6964;
continue;
...
var vec__6965 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6965,(0),null);
var end_column = cljs.core.nth.call(null,vec__6965,(1),null);
...
var vec__6968 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__6968,(0),null);
var column = cljs.core.nth.call(null,vec__6968,(1),null);
...
var vec__6973 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__6973,(0),null);
var column = cljs.core.nth.call(null,vec__6973,(1),null);
...
var vec__6978 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__6978,(0),null);
var column = cljs.core.nth.call(null,vec__6978,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__6983 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__6983,(0),null);
var start_column = cljs.core.nth.call(null,vec__6983,(1),null);
...
var vec__6986 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__6986,(0),null);
var end_column = cljs.core.nth.call(null,vec__6986,(1),null);
...
var G__6989 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__6989,true,null,opts,pending_forms);
...
var G__6990 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__6990)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__6990)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__6990)){
...
var _STAR_suppress_read_STAR_6991 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_6991;
}});
...
var G__6992 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__6992,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__6992,rdr,first_line);
...
var G__6996 = matched;
var G__6997 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__6996;
finished = G__6997;
continue;
} else {
...
var _STAR_suppress_read_STAR_6998 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_6998;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env6999 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__7000 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__7000,"(");
...
var G__7001 = (i + (1));
var G__7002 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3920__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3920__auto__)){
return or__3920__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env6999;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__7003 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__7003);
...
var G__7006 = cljs.core.next.call(null,s);
var G__7007 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__7006;
key_vals = G__7007;
continue;
} else {
...
var gensym_env7011 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env7011;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__7012 = token;
var G__7012__$1 = (((G__7012 == null))?null:cljs.core.subs.call(null,G__7012,(1)));
var G__7012__$2 = (((G__7012__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__7012__$1));
var G__7012__$3 = (((G__7012__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__7012__$2));
var G__7012__$4 = (((G__7012__$3 == null))?null:cljs.core.symbol.call(null,G__7012__$3));
if((G__7012__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__7012__$4);
}
})():(function (){var G__7013 = token;
var G__7013__$1 = (((G__7013 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__7013));
if((G__7013__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__7013__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
}catch (e7020){if((e7020 instanceof Error)){
var e = e7020;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__7024,reader){
var map__7025 = p__7024;
var map__7025__$1 = ((((!((map__7025 == null)))?(((((map__7025.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7025.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7025):map__7025);
var opts = map__7025__$1;
var eof = cljs.core.get.call(null,map__7025__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4497__auto___7033 = arguments.length;
var i__4498__auto___7034 = (0);
while(true){
if((i__4498__auto___7034 < len__4497__auto___7033)){
args__4500__auto__.push((arguments[i__4498__auto___7034]));

var G__7035 = (i__4498__auto___7034 + (1));
i__4498__auto___7034 = G__7035;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq7031){
var G__7032 = cljs.core.first.call(null,seq7031);
var seq7031__$1 = cljs.core.next.call(null,seq7031);
var self__4484__auto__ = this;
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__7032,seq7031__$1);
});

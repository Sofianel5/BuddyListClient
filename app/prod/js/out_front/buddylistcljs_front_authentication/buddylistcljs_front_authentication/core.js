...
buddylistcljs_front_authentication.core.phone_input = cljs.nodejs.require.call(null,"react-phone-number-input").PhoneInput;
if(typeof buddylistcljs_front_authentication.core.state !== 'undefined'){
} else {
buddylistcljs_front_authentication.core.state = reagent.core.atom.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"sign-up","sign-up",-1190725688),new cljs.core.Keyword(null,"message","message",-406056002),"Loaded"], null));
}
...
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"username","username",1605666410),new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"username","username",1605666410),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),new cljs.core.Keyword(null,"username","username",1605666410)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buddylistcljs_front_authentication.core.phone_input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"country","country",312965309),"US",new cljs.core.Keyword(null,"value","value",305978217),"+12133734253",new cljs.core.Keyword(null,"onchange","onchange",1355467329),(function (p1__1672_SHARP_){

...
return (new CustomEvent(event_name,(function (){var obj13305 = {"detail":data};
return obj13305;
})()));
} else {
...
var f = (function (){var pred__13312 = cljs.core._EQ_;
var expr__13313 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__13312.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__13313))){
return ((function (pred__13312,expr__13313){
return (function (p1__13306_SHARP_){
return console.warn(p1__13306_SHARP_);
});
;})(pred__13312,expr__13313))
} else {
if(cljs.core.truth_(pred__13312.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__13313))){
return ((function (pred__13312,expr__13313){
return (function (p1__13307_SHARP_){
return console.debug(p1__13307_SHARP_);
});
;})(pred__13312,expr__13313))
} else {
if(cljs.core.truth_(pred__13312.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__13313))){
return ((function (pred__13312,expr__13313){
return (function (p1__13308_SHARP_){
return console.error(p1__13308_SHARP_);
});
;})(pred__13312,expr__13313))
} else {
return ((function (pred__13312,expr__13313){
return (function (p1__13309_SHARP_){
return console.log(p1__13309_SHARP_);
});
;})(pred__13312,expr__13313))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__13316){
...
var eval_fn = cljs.core.get.call(null,map__13317__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__13319_SHARP_);
});})(new_def))
);
...
return (function (p__13320){
var vec__13321 = p__13320;
var ky = cljs.core.nth.call(null,vec__13321,(0),null);
var v = cljs.core.nth.call(null,vec__13321,(1),null);

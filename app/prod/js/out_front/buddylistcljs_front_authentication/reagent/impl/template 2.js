...
var G__4885 = o;
(G__4885[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__4892 = jsprops;
(G__4892["defaultValue"] = value);

(G__4892["onChange"] = ((function (G__4892,v,value,on_change){
return (function (p1__4890_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__4890_SHARP_);
});})(G__4892,v,value,on_change))
);

(G__4892["ref"] = ((function (G__4892,v,value,on_change){
return (function (p1__4891_SHARP_){
return (this$["cljsInputElement"] = p1__4891_SHARP_);
});})(G__4892,v,value,on_change))
);
...
var vec__4895 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__4895,(0),null);
var id = cljs.core.nth.call(null,vec__4895,(1),null);
var class$ = cljs.core.nth.call(null,vec__4895,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___4899 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___4899 == null)){
} else {
var key_4900 = temp__4661__auto___4899;
(jsprops["key"] = key_4900);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__4901 = (new reagent.impl.template.NativeWrapper());
(G__4901["name"] = c);
...
var len__4497__auto___4905 = arguments.length;
var i__4498__auto___4906 = (0);
while(true){
if((i__4498__auto___4906 < len__4497__auto___4905)){
args__4500__auto__.push((arguments[i__4498__auto___4906]));

var G__4907 = (i__4498__auto___4906 + (1));
i__4498__auto___4906 = G__4907;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq4903){
var G__4904 = cljs.core.first.call(null,seq4903);
var seq4903__$1 = cljs.core.next.call(null,seq4903);
var self__4484__auto__ = this;
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__4904,seq4903__$1);
});
...
break;
default:
var G__4910 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__4910;
continue;
...
var n__4374__auto___4912 = a.length;
var i_4913 = (0);
while(true){
if((i_4913 < n__4374__auto___4912)){
(a[i_4913] = reagent.impl.template.as_element.call(null,(a[i_4913])));

var G__4914 = (i_4913 + (1));
i_4913 = G__4914;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4374__auto___4915 = a.length;
var i_4916 = (0);
while(true){
if((i_4916 < n__4374__auto___4915)){
var val_4917 = (a[i_4916]);
if(((cljs.core.vector_QMARK_.call(null,val_4917)) && ((reagent.impl.template.key_from_vec.call(null,val_4917) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_4916] = reagent.impl.template.as_element.call(null,val_4917));
...
var ctx = ({});
var vec__4919 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__4919,(0),null);
var derefed = cljs.core.nth.call(null,vec__4919,(1),null);
...
var G__4922 = (cljs.core.count.call(null,argv) - first_child);
switch (G__4922) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__4922){

...
var G__10350 = o;
(G__10350[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10352__i < G__10352__a.length) {G__10352__a[G__10352__i] = arguments[G__10352__i + 0]; ++G__10352__i;}
  args = new cljs.core.IndexedSeq(G__10352__a,0,null);
} 
...
var G__10357 = jsprops;
(G__10357["defaultValue"] = value);

(G__10357["onChange"] = ((function (G__10357,v,value,on_change){
return (function (p1__10355_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10355_SHARP_);
});})(G__10357,v,value,on_change))
);

(G__10357["ref"] = ((function (G__10357,v,value,on_change){
return (function (p1__10356_SHARP_){
return (this$["cljsInputElement"] = p1__10356_SHARP_);
});})(G__10357,v,value,on_change))
);
...
var vec__10360 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10360,(0),null);
var id = cljs.core.nth.call(null,vec__10360,(1),null);
var class$ = cljs.core.nth.call(null,vec__10360,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___10364 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___10364 == null)){
} else {
var key_10365 = temp__4661__auto___10364;
(jsprops["key"] = key_10365);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__10366 = (new reagent.impl.template.NativeWrapper());
(G__10366["name"] = c);
...
var len__4497__auto___10370 = arguments.length;
var i__4498__auto___10371 = (0);
while(true){
if((i__4498__auto___10371 < len__4497__auto___10370)){
args__4500__auto__.push((arguments[i__4498__auto___10371]));

var G__10372 = (i__4498__auto___10371 + (1));
i__4498__auto___10371 = G__10372;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10368){
...
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10369,seq10368__$1);
});
...
break;
default:
var G__10375 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__10375;
continue;
...
var n__4374__auto___10377 = a.length;
var i_10378 = (0);
while(true){
if((i_10378 < n__4374__auto___10377)){
(a[i_10378] = reagent.impl.template.as_element.call(null,(a[i_10378])));
...
var a = cljs.core.into_array.call(null,s);
var n__4374__auto___10380 = a.length;
var i_10381 = (0);
while(true){
if((i_10381 < n__4374__auto___10380)){
var val_10382 = (a[i_10381]);
if(((cljs.core.vector_QMARK_.call(null,val_10382)) && ((reagent.impl.template.key_from_vec.call(null,val_10382) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10381] = reagent.impl.template.as_element.call(null,val_10382));

var G__10383 = (i_10381 + (1));
i_10381 = G__10383;
continue;
} else {
}
...
var ctx = ({});
var vec__10384 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__10384,(0),null);
var derefed = cljs.core.nth.call(null,vec__10384,(1),null);
...
var G__10387 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10387) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__10387){

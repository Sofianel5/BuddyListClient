...
var len__4497__auto___2135 = arguments.length;
var i__4498__auto___2136 = (0);
while(true){
if((i__4498__auto___2136 < len__4497__auto___2135)){
args__4500__auto__.push((arguments[i__4498__auto___2136]));

var G__2137 = (i__4498__auto___2136 + (1));
i__4498__auto___2136 = G__2137;
continue;
} else {
}
break;
...
/** @this {Function} */
buddylistcljs.user.none_nil.cljs$lang$applyTo = (function (seq2134){
var self__4485__auto__ = this;
return self__4485__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq2134));
});
...
var G__2138 = cljs.nodejs.process.platform;
switch (G__2138) {
case "darwin":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__2138)].join('')));
...
return (function (p1__2140_SHARP_){
return buddylistcljs.user.cache_user.call(null,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.js__GT_clj.call(null,p1__2140_SHARP_,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true)));
...
var request = buddylistcljs.user.axios.call(null,options);
return request.then(((function (params,options,request){
return (function (p1__2142_SHARP_){
return buddylistcljs.user.cache_user.call(null,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.js__GT_clj.call(null,p1__2142_SHARP_,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true)));
});})(params,options,request))
);
} else {
return null;
...
return new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.js__GT_clj.call(null,p1__2144_SHARP_,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true));
...
return new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.js__GT_clj.call(null,p1__2145_SHARP_,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true));
...
return p1__2146_SHARP_.data;
});})(headers,params,options,request))
).catch(((function (headers,params,options,request){
return (function (p1__2147_SHARP_){
return cljs.core.println.call(null,p1__2147_SHARP_);
});})(headers,params,options,request))
);
});

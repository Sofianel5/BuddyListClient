...
var G__5801 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__5801,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__5801;
}
});
...
var or__3920__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__4497__auto___5806 = arguments.length;
var i__4498__auto___5807 = (0);
while(true){
if((i__4498__auto___5807 < len__4497__auto___5806)){
args__4500__auto__.push((arguments[i__4498__auto___5807]));

var G__5808 = (i__4498__auto___5807 + (1));
i__4498__auto___5807 = G__5808;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4501__auto__);
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq5803){
var G__5804 = cljs.core.first.call(null,seq5803);
var seq5803__$1 = cljs.core.next.call(null,seq5803);
var G__5805 = cljs.core.first.call(null,seq5803__$1);
var seq5803__$2 = cljs.core.next.call(null,seq5803__$1);
var self__4484__auto__ = this;
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5804,G__5805,seq5803__$2);
});
...
var map__5810 = m;
var map__5810__$1 = ((((!((map__5810 == null)))?(((((map__5810.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5810.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__5810):map__5810);
var file = cljs.core.get.call(null,map__5810__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__5810__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__5810__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__5810,map__5810__$1,file,line,column){
return (function (p1__5809_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__5809_SHARP_));
});})(map__5810,map__5810__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__4380__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__4380__auto__,prefer_table__4381__auto__,method_cache__4382__auto__,cached_hierarchy__4383__auto__,hierarchy__4384__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__3920__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__3920__auto__)){
return or__3920__auto__;
} else {
...
var temp__4657__auto___5812 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___5812)){
var message_5813 = temp__4657__auto___5812;
cljs.core.println.call(null,message_5813);
} else {
}
...
var temp__4657__auto___5814 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___5814)){
var message_5815 = temp__4657__auto___5814;
cljs.core.println.call(null,message_5815);
} else {
}
...
var output_dir = "app/dev/js/out_main";
var output_dir__$1 = (function (){var G__5816 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5816),"/"].join('');
} else {
return G__5816;
}
})();
...
var temp__4655__auto__ = (function (){var and__3909__auto__ = typeof exception.stack === 'string';
if(and__3909__auto__){
var G__5818 = exception.stack;
var G__5818__$1 = (((G__5818 == null))?null:clojure.string.split_lines.call(null,G__5818));
var G__5818__$2 = (((G__5818__$1 == null))?null:cljs.core.get.call(null,G__5818__$1,depth));
if((G__5818__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__5818__$2);
}
} else {
...
var vec__5819 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__5819,(0),null);
var column = cljs.core.nth.call(null,vec__5819,(1),null);
var vec__5822 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__5822,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__5822,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__5822,(2),null);
...
var m__$1 = (function (){var G__5825 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__5829 = (function (){var G__5828 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__5828);
} else {
return G__5828;
}
})();
...
return cljs.core.vary_meta.call(null,G__5830,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e5831){var e = e5831;
var G__5832 = e;
var G__5832__$1 = (((G__5832 instanceof cljs.core.Keyword))?G__5832.fqn:null);
switch (G__5832__$1) {
...
var vec__5834 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__5834,(0),null);
var types = vec__5834;
...
return cljs.core.map.call(null,(function (p__5837){
var vec__5838 = p__5837;
var ns = cljs.core.nth.call(null,vec__5838,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__5838,(1),null);
return ((function (vec__5838,ns,vars__$1){
return (function (){
...
var G__5841 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__5841__$1 = (((G__5841 instanceof cljs.core.Keyword))?G__5841.fqn:null);
switch (G__5841__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__5841,G__5841__$1,env,once_fixtures,each_fixtures,vec__5838,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__5841,G__5841__$1,env,once_fixtures,each_fixtures,vec__5838,ns,vars__$1){
return (function (){
var seq__5842 = cljs.core.seq.call(null,vars__$1);
var chunk__5843 = null;
var count__5844 = (0);
var i__5845 = (0);
while(true){
if((i__5845 < count__5844)){
var v = cljs.core._nth.call(null,chunk__5843,i__5845);
var temp__4657__auto___5847 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___5847)){
var t_5848 = temp__4657__auto___5847;
each_fixture_fn.call(null,((function (seq__5842,chunk__5843,count__5844,i__5845,t_5848,temp__4657__auto___5847,v,each_fixture_fn,G__5841,G__5841__$1,env,once_fixtures,each_fixtures,vec__5838,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_5848)));
});})(seq__5842,chunk__5843,count__5844,i__5845,t_5848,temp__4657__auto___5847,v,each_fixture_fn,G__5841,G__5841__$1,env,once_fixtures,each_fixtures,vec__5838,ns,vars__$1))
);
} else {
}


var G__5849 = seq__5842;
var G__5850 = chunk__5843;
var G__5851 = count__5844;
var G__5852 = (i__5845 + (1));
seq__5842 = G__5849;
chunk__5843 = G__5850;
count__5844 = G__5851;
i__5845 = G__5852;
...
var temp__4657__auto__ = cljs.core.seq.call(null,seq__5842);
if(temp__4657__auto__){
var seq__5842__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__5842__$1)){
var c__4317__auto__ = cljs.core.chunk_first.call(null,seq__5842__$1);
var G__5853 = cljs.core.chunk_rest.call(null,seq__5842__$1);
var G__5854 = c__4317__auto__;
var G__5855 = cljs.core.count.call(null,c__4317__auto__);
var G__5856 = (0);
seq__5842 = G__5853;
chunk__5843 = G__5854;
count__5844 = G__5855;
...
var v = cljs.core.first.call(null,seq__5842__$1);
var temp__4657__auto___5857__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___5857__$1)){
var t_5858 = temp__4657__auto___5857__$1;
each_fixture_fn.call(null,((function (seq__5842,chunk__5843,count__5844,i__5845,t_5858,temp__4657__auto___5857__$1,v,seq__5842__$1,temp__4657__auto__,each_fixture_fn,G__5841,G__5841__$1,env,once_fixtures,each_fixtures,vec__5838,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_5858)));
});})(seq__5842,chunk__5843,count__5844,i__5845,t_5858,temp__4657__auto___5857__$1,v,seq__5842__$1,temp__4657__auto__,each_fixture_fn,G__5841,G__5841__$1,env,once_fixtures,each_fixtures,vec__5838,ns,vars__$1))
);
} else {
}


var G__5859 = cljs.core.next.call(null,seq__5842__$1);
var G__5860 = null;
var G__5861 = (0);
var G__5862 = (0);
seq__5842 = G__5859;
...
});})(each_fixture_fn,G__5841,G__5841__$1,env,once_fixtures,each_fixtures,vec__5838,ns,vars__$1))
);
});})(each_fixture_fn,G__5841,G__5841__$1,env,once_fixtures,each_fixtures,vec__5838,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5841__$1)].join('')));

}
})());
});
;})(vec__5838,ns,vars__$1))

...
var G__2117 = cljs.core.first.call(null,e);
...
return ((function (_,c,G__2117,G__2117__$1){
return (function (res,x){
cljs.core.swap_BANG_.call(null,res,cljs.core.into,cljs.core.map.call(null,c,x));

return then.call(null,res,null);
});
;})(_,c,G__2117,G__2117__$1))

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__2117__$1)].join('')));
...
if(cljs.core.not_any_QMARK_.call(null,(function (p1__2119_SHARP_){
return ((cljs.core.vector_QMARK_.call(null,p1__2119_SHARP_)) && (cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__2119_SHARP_),new cljs.core.Keyword("schema.spec.collection","remaining","schema.spec.collection/remaining",-421177821))));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__4170__auto__,k__4171__auto__){
var self__ = this;
var this__4170__auto____$1 = this;
return this__4170__auto____$1.cljs$core$ILookup$_lookup$arity$3(null,k__4171__auto__,null);
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4172__auto__,k2121,else__4173__auto__){
var self__ = this;
var this__4172__auto____$1 = this;
var G__2125 = k2121;
var G__2125__$1 = (((G__2125 instanceof cljs.core.Keyword))?G__2125.fqn:null);
switch (G__2125__$1) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k2121,else__4173__auto__);
...
if(cljs.core.truth_((function (){var or__3920__auto____$1 = cljs.core.seq.call(null,remaining);
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (this__4184__auto__,writer__4185__auto__,opts__4186__auto__){
var self__ = this;
...
;
return cljs.core.pr_sequential_writer.call(null,writer__4185__auto__,pr_pair__4187__auto__,"#schema.spec.collection.CollectionSpec{",", ","}",opts__4186__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"pre","pre",2118456869),self__.pre],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"constructor","constructor",-1953928811),self__.constructor$],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"elements","elements",657646735),self__.elements],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"on-error","on-error",1728533530),self__.on_error],null))], null),self__.__extmap));
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__2120){
var self__ = this;
var G__2120__$1 = this;
return (new cljs.core.RecordIter((0),G__2120__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"constructor","constructor",-1953928811),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$IMeta$_meta$arity$1 = (function (this__4168__auto__){
var self__ = this;
var this__4168__auto____$1 = this;
return self__.__meta;
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$ICloneable$_clone$arity$1 = (function (this__4165__auto__){
var self__ = this;
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__4174__auto__){
var self__ = this;
var this__4174__auto____$1 = this;
return (4 + cljs.core.count.call(null,self__.__extmap));
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__4166__auto__){
var self__ = this;
...
return (1800698765 ^ cljs.core.hash_unordered_coll.call(null,coll__4167__auto__));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this2122,other2123){
var self__ = this;
var this2122__$1 = this;
return ((!((other2123 == null))) && ((this2122__$1.constructor === other2123.constructor)) && (cljs.core._EQ_.call(null,this2122__$1.pre,other2123.pre)) && (cljs.core._EQ_.call(null,this2122__$1.constructor,other2123.constructor)) && (cljs.core._EQ_.call(null,this2122__$1.elements,other2123.elements)) && (cljs.core._EQ_.call(null,this2122__$1.on_error,other2123.on_error)) && (cljs.core._EQ_.call(null,this2122__$1.__extmap,other2123.__extmap)));
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__4179__auto__,k__4180__auto__){
var self__ = this;
var this__4179__auto____$1 = this;
if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"pre","pre",2118456869),null,new cljs.core.Keyword(null,"elements","elements",657646735),null,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),null,new cljs.core.Keyword(null,"on-error","on-error",1728533530),null], null), null),k__4180__auto__)){
...
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__4180__auto__)),null));
}
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4177__auto__,k__4178__auto__,G__2120){
var self__ = this;
var this__4177__auto____$1 = this;
var pred__2126 = cljs.core.keyword_identical_QMARK_;
var expr__2127 = k__4178__auto__;
if(cljs.core.truth_(pred__2126.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__2127))){
return (new schema.spec.collection.CollectionSpec(G__2120,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__2126.call(null,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),expr__2127))){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__2120,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__2126.call(null,new cljs.core.Keyword(null,"elements","elements",657646735),expr__2127))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__2120,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__2126.call(null,new cljs.core.Keyword(null,"on-error","on-error",1728533530),expr__2127))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__2120,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4178__auto__,G__2120),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__4182__auto__){
var self__ = this;
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4169__auto__,G__2120){
var self__ = this;
var this__4169__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__2120,self__.__extmap,self__.__hash));
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$ICollection$_conj$arity$2 = (function (this__4175__auto__,entry__4176__auto__){
var self__ = this;
...
schema.spec.collection.CollectionSpec.cljs$lang$ctorPrSeq = (function (this__4206__auto__){
return (new cljs.core.List(null,"schema.spec.collection/CollectionSpec",null,(1),null));
});

schema.spec.collection.CollectionSpec.cljs$lang$ctorPrWriter = (function (this__4206__auto__,writer__4207__auto__){
return cljs.core._write.call(null,writer__4207__auto__,"schema.spec.collection/CollectionSpec");
});
 ...
 */
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__2124){
return (new schema.spec.collection.CollectionSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__2124),new cljs.core.Keyword(null,"constructor","constructor",-1953928811).cljs$core$IFn$_invoke$arity$1(G__2124),new cljs.core.Keyword(null,"elements","elements",657646735).cljs$core$IFn$_invoke$arity$1(G__2124),new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__2124),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__2124,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"constructor","constructor",-1953928811),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530))),null));
});
...
var len__4497__auto___2131 = arguments.length;
var i__4498__auto___2132 = (0);
while(true){
if((i__4498__auto___2132 < len__4497__auto___2131)){
args__4500__auto__.push((arguments[i__4498__auto___2132]));

var G__2133 = (i__4498__auto___2132 + (1));
i__4498__auto___2132 = G__2133;
continue;
} else {
}
break;
...
return schema.spec.collection.optional.cljs$core$IFn$_invoke$arity$variadic(argseq__4501__auto__);
});
...
/** @this {Function} */
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq2130){
var self__4485__auto__ = this;
return self__4485__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq2130));
});

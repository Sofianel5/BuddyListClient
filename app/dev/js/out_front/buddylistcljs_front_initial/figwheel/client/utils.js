...
return (new CustomEvent(event_name,(function (){var obj27365 = {"detail":data};
return obj27365;
})()));
} else {
...
var f = (function (){var pred__27372 = cljs.core._EQ_;
var expr__27373 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27372.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27373))){
return ((function (pred__27372,expr__27373){
return (function (p1__27366_SHARP_){
return console.warn(p1__27366_SHARP_);
});
;})(pred__27372,expr__27373))
} else {
if(cljs.core.truth_(pred__27372.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27373))){
return ((function (pred__27372,expr__27373){
return (function (p1__27367_SHARP_){
return console.debug(p1__27367_SHARP_);
});
;})(pred__27372,expr__27373))
} else {
if(cljs.core.truth_(pred__27372.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27373))){
return ((function (pred__27372,expr__27373){
return (function (p1__27368_SHARP_){
return console.error(p1__27368_SHARP_);
});
;})(pred__27372,expr__27373))
} else {
return ((function (pred__27372,expr__27373){
return (function (p1__27369_SHARP_){
return console.log(p1__27369_SHARP_);
});
;})(pred__27372,expr__27373))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27376){
...
var opts = map__27377__$1;
var eval_fn = cljs.core.get.call(null,map__27377__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27379_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27381,(0),null);

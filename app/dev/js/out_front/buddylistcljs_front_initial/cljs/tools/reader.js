...
var G__24599 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24599;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24600 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24600,ch);
...
if(("\\" === ch__$1)){
var ch_24601__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24601__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24601__$2);
} else {
}

var G__24602 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24602;
continue;
}
}
...
var vec__24610 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24610,(0),null);
var start_column = cljs.core.nth.call(null,vec__24610,(1),null);
...
var G__24613 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24613;
continue;
}
}
...
var _STAR_read_delim_STAR_24614 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_24614;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24615 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24615,(0),null);
var start_column = cljs.core.nth.call(null,vec__24615,(1),null);
...
var vec__24618 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24618,(0),null);
var end_column = cljs.core.nth.call(null,vec__24618,(1),null);
...
var vec__24621 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24621,(0),null);
var start_column = cljs.core.nth.call(null,vec__24621,(1),null);
...
var vec__24624 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24624,(0),null);
var end_column = cljs.core.nth.call(null,vec__24624,(1),null);
...
var vec__24627 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24627,(0),null);
var start_column = cljs.core.nth.call(null,vec__24627,(1),null);
...
var vec__24630 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24630,(0),null);
var end_column = cljs.core.nth.call(null,vec__24630,(1),null);
...
var sb = (function (){var G__24633 = (new goog.string.StringBuffer());
G__24633.append(initch);
...
var G__24635 = (function (){var G__24634 = sb;
G__24634.append(ch);

return G__24634;
})();
var G__24636 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24635;
ch = G__24636;
continue;
}
...
switch (G__24639) {
case "\\":
var G__24643 = (function (){var G__24640 = sb;
G__24640.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24640;
})();
var G__24644 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24643;
ch = G__24644;
continue;
...
break;
default:
var G__24645 = (function (){var G__24641 = sb;
G__24641.append(ch);

return G__24641;
})();
var G__24646 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24645;
ch = G__24646;
continue;
...
var vec__24647 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24647,(0),null);
var end_column = cljs.core.nth.call(null,vec__24647,(1),null);
...
var vec__24650 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24650,(0),null);
var column = cljs.core.nth.call(null,vec__24650,(1),null);
...
var vec__24655 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24655,(0),null);
var column = cljs.core.nth.call(null,vec__24655,(1),null);
...
var vec__24660 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24660,(0),null);
var column = cljs.core.nth.call(null,vec__24660,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24665 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24665,(0),null);
var start_column = cljs.core.nth.call(null,vec__24665,(1),null);
...
var vec__24668 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24668,(0),null);
var end_column = cljs.core.nth.call(null,vec__24668,(1),null);
...
var G__24671 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24671,true,null,opts,pending_forms);
...
var G__24672 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24672)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24672)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24672)){
...
var _STAR_suppress_read_STAR_24673 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24673;
}});
...
var G__24674 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24674,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24674,rdr,first_line);
...
var G__24678 = matched;
var G__24679 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24678;
finished = G__24679;
continue;
} else {
...
var _STAR_suppress_read_STAR_24680 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24680;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env24681 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24682 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24682,"(");
...
var G__24683 = (i + (1));
var G__24684 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3920__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3920__auto__)){
return or__3920__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env24681;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24685 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24685);
...
var G__24686 = cljs.core.next.call(null,s__$1);
var G__24687 = ret;
s__$1 = G__24686;
r = G__24687;
continue;
...
var G__24688 = cljs.core.next.call(null,s);
var G__24689 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24688;
key_vals = G__24689;
continue;
} else {
...
var gensym_env24693 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env24693;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24694 = token;
var G__24694__$1 = (((G__24694 == null))?null:cljs.core.subs.call(null,G__24694,(1)));
var G__24694__$2 = (((G__24694__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24694__$1));
var G__24694__$3 = (((G__24694__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24694__$2));
var G__24694__$4 = (((G__24694__$3 == null))?null:cljs.core.symbol.call(null,G__24694__$3));
if((G__24694__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24694__$4);
}
})():(function (){var G__24695 = token;
var G__24695__$1 = (((G__24695 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24695));
if((G__24695__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24695__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
}catch (e24702){if((e24702 instanceof Error)){
var e = e24702;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24706,reader){
...
var eof = cljs.core.get.call(null,map__24707__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4497__auto___24715 = arguments.length;
var i__4498__auto___24716 = (0);
while(true){
if((i__4498__auto___24716 < len__4497__auto___24715)){
args__4500__auto__.push((arguments[i__4498__auto___24716]));

var G__24717 = (i__4498__auto___24716 + (1));
i__4498__auto___24716 = G__24717;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24713){
...
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24714,seq24713__$1);
});

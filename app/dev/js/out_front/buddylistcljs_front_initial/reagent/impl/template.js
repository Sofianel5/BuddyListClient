...
var G__24410 = o;
(G__24410[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__24411__delegate = function (args){
...
while (G__24412__i < G__24412__a.length) {G__24412__a[G__24412__i] = arguments[G__24412__i + 0]; ++G__24412__i;}
  args = new cljs.core.IndexedSeq(G__24412__a,0,null);
} 
return G__24411__delegate.call(this,args);};
...
return G__24411__delegate(args);
});
...
var G__24417 = jsprops;
(G__24417["defaultValue"] = value);

(G__24417["onChange"] = ((function (G__24417,v,value,on_change){
return (function (p1__24415_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24415_SHARP_);
});})(G__24417,v,value,on_change))
);

(G__24417["ref"] = ((function (G__24417,v,value,on_change){
return (function (p1__24416_SHARP_){
return (this$["cljsInputElement"] = p1__24416_SHARP_);
});})(G__24417,v,value,on_change))
);
...
var vec__24420 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24420,(0),null);
var id = cljs.core.nth.call(null,vec__24420,(1),null);
var class$ = cljs.core.nth.call(null,vec__24420,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___24424 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___24424 == null)){
} else {
var key_24425 = temp__4661__auto___24424;
(jsprops["key"] = key_24425);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__24426 = (new reagent.impl.template.NativeWrapper());
(G__24426["name"] = c);
...
var len__4497__auto___24430 = arguments.length;
var i__4498__auto___24431 = (0);
while(true){
if((i__4498__auto___24431 < len__4497__auto___24430)){
args__4500__auto__.push((arguments[i__4498__auto___24431]));

var G__24432 = (i__4498__auto___24431 + (1));
i__4498__auto___24431 = G__24432;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq24428){
...
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24429,seq24428__$1);
});
...
break;
default:
var G__24435 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__24435;
continue;
...
var n__4374__auto___24437 = a.length;
var i_24438 = (0);
while(true){
if((i_24438 < n__4374__auto___24437)){
(a[i_24438] = reagent.impl.template.as_element.call(null,(a[i_24438])));

var G__24439 = (i_24438 + (1));
i_24438 = G__24439;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4374__auto___24440 = a.length;
var i_24441 = (0);
while(true){
if((i_24441 < n__4374__auto___24440)){
var val_24442 = (a[i_24441]);
if(((cljs.core.vector_QMARK_.call(null,val_24442)) && ((reagent.impl.template.key_from_vec.call(null,val_24442) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_24441] = reagent.impl.template.as_element.call(null,val_24442));

var G__24443 = (i_24441 + (1));
i_24441 = G__24443;
continue;
} else {
}
...
var ctx = ({});
var vec__24444 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__24444,(0),null);
var derefed = cljs.core.nth.call(null,vec__24444,(1),null);
...
var G__24447 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24447) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24447){

...
var G__7102 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__7102;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__7103 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__7103,ch);
...
if(("\\" === ch__$1)){
var ch_7104__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_7104__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_7104__$2);
} else {
}

var G__7105 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__7105;
continue;
}
}
...
var vec__7113 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__7113,(0),null);
var start_column = cljs.core.nth.call(null,vec__7113,(1),null);
...
var G__7116 = cljs.core.conj_BANG_.call(null,a,form);
a = G__7116;
continue;
}
}
...
var _STAR_read_delim_STAR_7117 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_7117;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__7118 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__7118,(0),null);
var start_column = cljs.core.nth.call(null,vec__7118,(1),null);
...
var vec__7121 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__7121,(0),null);
var end_column = cljs.core.nth.call(null,vec__7121,(1),null);
...
var sb = (function (){var G__7136 = (new goog.string.StringBuffer());
G__7136.append(initch);
...
var G__7138 = (function (){var G__7137 = sb;
G__7137.append(ch);

return G__7137;
})();
var G__7139 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__7138;
ch = G__7139;
continue;
}
...
switch (G__7142) {
case "\\":
var G__7146 = (function (){var G__7143 = sb;
G__7143.append(cljs.tools.reader.escape_char.call(null,sb,reader));
...
break;
default:
var G__7148 = (function (){var G__7144 = sb;
G__7144.append(ch);

return G__7144;
})();
var G__7149 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__7148;
ch = G__7149;
continue;
...
var vec__7150 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__7150,(0),null);
var end_column = cljs.core.nth.call(null,vec__7150,(1),null);
...
var vec__7153 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__7153,(0),null);
var column = cljs.core.nth.call(null,vec__7153,(1),null);
...
var vec__7158 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__7158,(0),null);
var column = cljs.core.nth.call(null,vec__7158,(1),null);
...
var vec__7163 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__7163,(0),null);
var column = cljs.core.nth.call(null,vec__7163,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__7168 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__7168,(0),null);
var start_column = cljs.core.nth.call(null,vec__7168,(1),null);
...
var vec__7171 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__7171,(0),null);
var end_column = cljs.core.nth.call(null,vec__7171,(1),null);
...
var G__7174 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__7174,true,null,opts,pending_forms);
...
var G__7175 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__7175)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__7175)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__7175)){
...
var _STAR_suppress_read_STAR_7176 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_7176;
}});
...
var G__7177 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__7177,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__7177,rdr,first_line);
...
var G__7181 = matched;
var G__7182 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__7181;
finished = G__7182;
continue;
} else {
...
var _STAR_suppress_read_STAR_7183 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_7183;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env7184 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__7185 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__7185,"(");
...
var G__7186 = (i + (1));
var G__7187 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3920__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3920__auto__)){
return or__3920__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env7184;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__7188 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__7188);
...
var G__7189 = cljs.core.next.call(null,s__$1);
var G__7190 = ret;
s__$1 = G__7189;
r = G__7190;
continue;
...
var G__7191 = cljs.core.next.call(null,s);
var G__7192 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__7191;
key_vals = G__7192;
continue;
} else {
...
var gensym_env7196 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env7196;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__7197 = token;
var G__7197__$1 = (((G__7197 == null))?null:cljs.core.subs.call(null,G__7197,(1)));
var G__7197__$2 = (((G__7197__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__7197__$1));
var G__7197__$3 = (((G__7197__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__7197__$2));
var G__7197__$4 = (((G__7197__$3 == null))?null:cljs.core.symbol.call(null,G__7197__$3));
if((G__7197__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__7197__$4);
}
})():(function (){var G__7198 = token;
var G__7198__$1 = (((G__7198 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__7198));
if((G__7198__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__7198__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__7209,reader){
var map__7210 = p__7209;
var map__7210__$1 = ((((!((map__7210 == null)))?(((((map__7210.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7210.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7210):map__7210);
var opts = map__7210__$1;
var eof = cljs.core.get.call(null,map__7210__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq7216){
var G__7217 = cljs.core.first.call(null,seq7216);
var seq7216__$1 = cljs.core.next.call(null,seq7216);
var self__4484__auto__ = this;
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__7217,seq7216__$1);
});

...
return (new CustomEvent(event_name,(function (){var obj9867 = {"detail":data};
return obj9867;
})()));
} else {
...
var f = (function (){var pred__9874 = cljs.core._EQ_;
var expr__9875 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__9874.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__9875))){
return ((function (pred__9874,expr__9875){
return (function (p1__9868_SHARP_){
return console.warn(p1__9868_SHARP_);
});
;})(pred__9874,expr__9875))
} else {
if(cljs.core.truth_(pred__9874.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__9875))){
return ((function (pred__9874,expr__9875){
return (function (p1__9869_SHARP_){
return console.debug(p1__9869_SHARP_);
});
;})(pred__9874,expr__9875))
} else {
if(cljs.core.truth_(pred__9874.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__9875))){
return ((function (pred__9874,expr__9875){
return (function (p1__9870_SHARP_){
return console.error(p1__9870_SHARP_);
});
;})(pred__9874,expr__9875))
} else {
return ((function (pred__9874,expr__9875){
return (function (p1__9871_SHARP_){
return console.log(p1__9871_SHARP_);
});
;})(pred__9874,expr__9875))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__9878){
var map__9879 = p__9878;
var map__9879__$1 = ((((!((map__9879 == null)))?(((((map__9879.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9879.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9879):map__9879);
var opts = map__9879__$1;
var eval_fn = cljs.core.get.call(null,map__9879__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__9881_SHARP_);
});})(new_def))
);
...
return (function (p__9882){
var vec__9883 = p__9882;
var ky = cljs.core.nth.call(null,vec__9883,(0),null);
var v = cljs.core.nth.call(null,vec__9883,(1),null);

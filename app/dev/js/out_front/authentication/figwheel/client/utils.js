...
return (new CustomEvent(event_name,(function (){var obj7956 = {"detail":data};
return obj7956;
})()));
} else {
...
var f = (function (){var pred__7963 = cljs.core._EQ_;
var expr__7964 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__7963.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__7964))){
return ((function (pred__7963,expr__7964){
return (function (p1__7957_SHARP_){
return console.warn(p1__7957_SHARP_);
});
;})(pred__7963,expr__7964))
} else {
if(cljs.core.truth_(pred__7963.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__7964))){
return ((function (pred__7963,expr__7964){
return (function (p1__7958_SHARP_){
return console.debug(p1__7958_SHARP_);
});
;})(pred__7963,expr__7964))
} else {
if(cljs.core.truth_(pred__7963.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__7964))){
return ((function (pred__7963,expr__7964){
return (function (p1__7959_SHARP_){
return console.error(p1__7959_SHARP_);
});
;})(pred__7963,expr__7964))
} else {
return ((function (pred__7963,expr__7964){
return (function (p1__7960_SHARP_){
return console.log(p1__7960_SHARP_);
});
;})(pred__7963,expr__7964))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__7967){
...
var opts = map__7968__$1;
var eval_fn = cljs.core.get.call(null,map__7968__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__7970_SHARP_);
});})(new_def))
);
...
return (function (p__7971){
var vec__7972 = p__7971;
var ky = cljs.core.nth.call(null,vec__7972,(0),null);

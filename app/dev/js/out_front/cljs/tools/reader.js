...
var G__24787 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24787;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24788 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24788,ch);
...
if(("\\" === ch__$1)){
var ch_24789__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24789__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24789__$2);
} else {
}
...
var vec__24798 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24798,(0),null);
var start_column = cljs.core.nth.call(null,vec__24798,(1),null);
...
var G__24801 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24801;
continue;
}
}
...
var _STAR_read_delim_STAR_24802 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_24802;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24803 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24803,(0),null);
var start_column = cljs.core.nth.call(null,vec__24803,(1),null);
...
var vec__24806 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24806,(0),null);
var end_column = cljs.core.nth.call(null,vec__24806,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__24809,(0),null);
var start_column = cljs.core.nth.call(null,vec__24809,(1),null);
...
var vec__24812 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24812,(0),null);
var end_column = cljs.core.nth.call(null,vec__24812,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__24815,(0),null);
var start_column = cljs.core.nth.call(null,vec__24815,(1),null);
...
var vec__24818 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24818,(0),null);
var end_column = cljs.core.nth.call(null,vec__24818,(1),null);
...
var sb = (function (){var G__24821 = (new goog.string.StringBuffer());
G__24821.append(initch);
...
var G__24823 = (function (){var G__24822 = sb;
G__24822.append(ch);

return G__24822;
})();
var G__24824 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24823;
ch = G__24824;
continue;
}
...
switch (G__24827) {
case "\\":
var G__24831 = (function (){var G__24828 = sb;
G__24828.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24828;
})();
var G__24832 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24831;
ch = G__24832;
continue;
...
break;
default:
var G__24833 = (function (){var G__24829 = sb;
G__24829.append(ch);

return G__24829;
})();
var G__24834 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24833;
ch = G__24834;
continue;
...
var vec__24835 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24835,(0),null);
var end_column = cljs.core.nth.call(null,vec__24835,(1),null);
...
var vec__24838 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24838,(0),null);
var column = cljs.core.nth.call(null,vec__24838,(1),null);
...
var vec__24843 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24843,(0),null);
var column = cljs.core.nth.call(null,vec__24843,(1),null);
...
var vec__24848 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24848,(0),null);
var column = cljs.core.nth.call(null,vec__24848,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24853 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24853,(0),null);
var start_column = cljs.core.nth.call(null,vec__24853,(1),null);
...
var vec__24856 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24856,(0),null);
var end_column = cljs.core.nth.call(null,vec__24856,(1),null);
...
var G__24859 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24859,true,null,opts,pending_forms);
...
var G__24860 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24860)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24860)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24860)){
...
var _STAR_suppress_read_STAR_24861 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24861;
}});
...
var G__24862 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24862,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24862,rdr,first_line);
...
var G__24866 = matched;
var G__24867 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24866;
finished = G__24867;
continue;
} else {
...
var _STAR_suppress_read_STAR_24868 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24868;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env24869 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24870 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24870,"(");
...
var G__24871 = (i + (1));
var G__24872 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3920__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3920__auto__)){
return or__3920__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env24869;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24873 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24873);
...
var G__24874 = cljs.core.next.call(null,s__$1);
var G__24875 = ret;
s__$1 = G__24874;
r = G__24875;
continue;
...
var G__24877 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24876;
key_vals = G__24877;
continue;
} else {
...
var gensym_env24881 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env24881;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24882 = token;
var G__24882__$1 = (((G__24882 == null))?null:cljs.core.subs.call(null,G__24882,(1)));
var G__24882__$2 = (((G__24882__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24882__$1));
var G__24882__$3 = (((G__24882__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24882__$2));
var G__24882__$4 = (((G__24882__$3 == null))?null:cljs.core.symbol.call(null,G__24882__$3));
if((G__24882__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24882__$4);
}
})():(function (){var G__24883 = token;
var G__24883__$1 = (((G__24883 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24883));
if((G__24883__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24883__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
}catch (e24890){if((e24890 instanceof Error)){
var e = e24890;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24894,reader){
...
var eof = cljs.core.get.call(null,map__24895__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4497__auto___24903 = arguments.length;
var i__4498__auto___24904 = (0);
while(true){
if((i__4498__auto___24904 < len__4497__auto___24903)){
args__4500__auto__.push((arguments[i__4498__auto___24904]));

var G__24905 = (i__4498__auto___24904 + (1));
i__4498__auto___24904 = G__24905;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24901){
...
return self__4484__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24902,seq24901__$1);
});

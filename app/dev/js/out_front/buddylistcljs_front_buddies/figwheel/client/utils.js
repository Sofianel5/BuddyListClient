...
return (new CustomEvent(event_name,(function (){var obj9846 = {"detail":data};
return obj9846;
})()));
} else {
...
var f = (function (){var pred__9853 = cljs.core._EQ_;
var expr__9854 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__9853.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__9854))){
return ((function (pred__9853,expr__9854){
return (function (p1__9847_SHARP_){
return console.warn(p1__9847_SHARP_);
});
;})(pred__9853,expr__9854))
} else {
if(cljs.core.truth_(pred__9853.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__9854))){
return ((function (pred__9853,expr__9854){
return (function (p1__9848_SHARP_){
return console.debug(p1__9848_SHARP_);
});
;})(pred__9853,expr__9854))
} else {
if(cljs.core.truth_(pred__9853.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__9854))){
return ((function (pred__9853,expr__9854){
return (function (p1__9849_SHARP_){
return console.error(p1__9849_SHARP_);
});
;})(pred__9853,expr__9854))
} else {
return ((function (pred__9853,expr__9854){
return (function (p1__9850_SHARP_){
return console.log(p1__9850_SHARP_);
});
;})(pred__9853,expr__9854))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__9857){
...
var opts = map__9858__$1;
var eval_fn = cljs.core.get.call(null,map__9858__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__9860_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__9862,(0),null);
var v = cljs.core.nth.call(null,vec__9862,(1),null);

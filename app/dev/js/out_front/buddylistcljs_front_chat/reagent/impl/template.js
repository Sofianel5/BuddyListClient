...
var G__6675 = o;
(G__6675[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__6682 = jsprops;
(G__6682["defaultValue"] = value);

(G__6682["onChange"] = ((function (G__6682,v,value,on_change){
return (function (p1__6680_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__6680_SHARP_);
});})(G__6682,v,value,on_change))
);

(G__6682["ref"] = ((function (G__6682,v,value,on_change){
return (function (p1__6681_SHARP_){
return (this$["cljsInputElement"] = p1__6681_SHARP_);
});})(G__6682,v,value,on_change))
);
...
var vec__6685 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__6685,(0),null);
var id = cljs.core.nth.call(null,vec__6685,(1),null);
var class$ = cljs.core.nth.call(null,vec__6685,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___6689 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___6689 == null)){
} else {
var key_6690 = temp__4661__auto___6689;
(jsprops["key"] = key_6690);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__6691 = (new reagent.impl.template.NativeWrapper());
(G__6691["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq6693){
...
break;
default:
var G__6700 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__6700;
continue;
...
var n__4374__auto___6702 = a.length;
var i_6703 = (0);
while(true){
if((i_6703 < n__4374__auto___6702)){
(a[i_6703] = reagent.impl.template.as_element.call(null,(a[i_6703])));

var G__6704 = (i_6703 + (1));
i_6703 = G__6704;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4374__auto___6705 = a.length;
var i_6706 = (0);
while(true){
if((i_6706 < n__4374__auto___6705)){
var val_6707 = (a[i_6706]);
if(((cljs.core.vector_QMARK_.call(null,val_6707)) && ((reagent.impl.template.key_from_vec.call(null,val_6707) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_6706] = reagent.impl.template.as_element.call(null,val_6707));

var G__6708 = (i_6706 + (1));
i_6706 = G__6708;
continue;
} else {
}
...
var ctx = ({});
var vec__6709 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__6709,(0),null);
var derefed = cljs.core.nth.call(null,vec__6709,(1),null);
...
var G__6712 = (cljs.core.count.call(null,argv) - first_child);
switch (G__6712) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__6712){

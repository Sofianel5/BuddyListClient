...
return (new CustomEvent(event_name,(function (){var obj9903 = {"detail":data};
return obj9903;
})()));
} else {
...
var f = (function (){var pred__9910 = cljs.core._EQ_;
var expr__9911 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__9910.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__9911))){
return ((function (pred__9910,expr__9911){
return (function (p1__9904_SHARP_){
return console.warn(p1__9904_SHARP_);
});
;})(pred__9910,expr__9911))
} else {
if(cljs.core.truth_(pred__9910.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__9911))){
return ((function (pred__9910,expr__9911){
return (function (p1__9905_SHARP_){
return console.debug(p1__9905_SHARP_);
});
;})(pred__9910,expr__9911))
} else {
if(cljs.core.truth_(pred__9910.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__9911))){
return ((function (pred__9910,expr__9911){
return (function (p1__9906_SHARP_){
return console.error(p1__9906_SHARP_);
});
;})(pred__9910,expr__9911))
} else {
return ((function (pred__9910,expr__9911){
return (function (p1__9907_SHARP_){
return console.log(p1__9907_SHARP_);
});
;})(pred__9910,expr__9911))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__9914){
var map__9915 = p__9914;
var map__9915__$1 = ((((!((map__9915 == null)))?(((((map__9915.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9915.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9915):map__9915);
var opts = map__9915__$1;
var eval_fn = cljs.core.get.call(null,map__9915__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__9917_SHARP_){
return new_def.callback(p1__9917_SHARP_);
});})(new_def))
);
...
return (function (p__9918){
var vec__9919 = p__9918;
var ky = cljs.core.nth.call(null,vec__9919,(0),null);
